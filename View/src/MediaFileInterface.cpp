...
void MediaFileInterface::enterMediaFileName(int input_case)
{
    ...
    case ADD_TO_PLAYLIST:
        cout << "Enter index of media file that you want to add to this playlist: " << endl;
        break;

    case DELETE_FROM_PLAYLIST:
        cout << "Enter index of media file that you want to delete from this playlist: " << endl;
        break;
